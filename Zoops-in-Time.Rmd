...
BiocManager::install("phyloseq", "dada2")
...
- These stats are in *Table S2* (bottom)
...
Run models to test for differences in zooplankton community, using Shannon diversity.  
- First look for the model that best explains the data using StepAIC. 
- These stats are in *Table S2* (top)
