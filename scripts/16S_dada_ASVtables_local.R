...
saveRDS(asv_fasta, "output/reanalysis/ASV_fasta.rds")
write(asv_fasta, "output/reanalysis/ASVs.fa")
...
write.table(asv_tab, "output/reanalysis/ASV_counts.tsv", sep = "\t", quote = F, col.names = NA)
...
write.table(taxa, "output/reanalysis/ASV_taxonomy.tsv", sep = "\t", quote = F, col.names = NA)
